...
import com.example.phaze.data.remote.dto.AlbumWithSongs
import com.example.phaze.data.remote.dto.ArtistID3
import com.example.phaze.data.remote.dto.ArtistWithAlbums
import com.example.phaze.data.remote.dto.Child
import com.example.phaze.data.remote.dto.PlaylistInfo
import com.example.phaze.data.remote.dto.PlaylistWithSongs
...
fun ArtistWithAlbums.toEntity(): ArtistEntity = ArtistEntity(
    id = id,
    name = name,
    albumCount = albumCount,
    coverArt = coverArt,
...
fun AlbumWithSongs.toEntity(): AlbumEntity = AlbumEntity(
    id = id,
    name = name,
    artistId = artistId ?: "",
    artistName = artist ?: "",
...
fun PlaylistInfo.toEntity(): PlaylistEntity = PlaylistEntity(
    id = id,
    name = name ?: "",
    songCount = songCount,
    duration = duration,
